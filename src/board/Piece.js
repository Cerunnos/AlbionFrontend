...
//What passes for piece graphics...
  ...
  //
    if(this.state.unit !== null){
      ...
      //Longship Sniper
      else if (this.state.activated===true && this.state.unit.name==="Longship Sniper" && this.state.armyNumber===1){
        return <div className="army1Activated" id={combinedImgId}><img id={combinedImgId} src={require("../pictures/target.png")} alt="ship" width="30" height="30"/></div>
      }
      else if(this.state.active && this.state.selected && this.state.unit.name==="Longship Sniper" && this.state.armyNumber===1){
        return <div className="selected" id={combinedImgId}><img id={combinedImgId} src={require("../pictures/target.png")} alt="ship" width="30" height="30"/></div>
      }else if(this.state.active && this.state.unit.name==="Longship Sniper" && this.state.armyNumber===1){
        return <div className="army1" id={combinedImgId}><img id={combinedImgId} src={require("../pictures/target.png")} alt="ship" width="30" height="30" /></div>
      }
      else if (this.state.activated===true && this.state.unit.name==="Longship Sniper" && this.state.armyNumber===2){
        return <div className="army2Activated" id={combinedImgId}><img id={combinedImgId} src={require("../pictures/target.png")} alt="ship" width="30" height="30"/></div>
      }else if(this.state.active && this.state.selected && this.state.unit.name==="Longship Sniper"){
        return <div className="selected" id={combinedImgId}><img id={combinedImgId} src={require("../pictures/target.png")} alt="ship" width="30" height="30"/></div>
      }else if(this.state.active && this.state.unit.name==="Longship Sniper"){
        return <div className="army2" id={combinedImgId}><img id={combinedImgId} src={require("../pictures/target.png")} alt="ship" width="30" height="30" /></div>
      }
      //Fanatic
      else if (this.state.activated===true && this.state.unit.name==="Fanatic" && this.state.armyNumber===1){
        return <div className="army1Activated" id={combinedImgId}><img id={combinedImgId} src={require("../pictures/cultist.png")} alt="ship" width="30" height="30"/></div>
      }
      else if(this.state.active && this.state.selected && this.state.unit.name==="Fanatic" && this.state.armyNumber===1){
        return <div className="selected" id={combinedImgId}><img id={combinedImgId} src={require("../pictures/cultist.png")} alt="ship" width="30" height="30"/></div>
      }else if(this.state.active && this.state.unit.name==="Fanatic" && this.state.armyNumber===1){
        return <div className="army1" id={combinedImgId}><img id={combinedImgId} src={require("../pictures/cultist.png")} alt="ship" width="30" height="30" /></div>
      }
      else if (this.state.activated===true && this.state.unit.name==="Fanatic" && this.state.armyNumber===2){
        return <div className="army2Activated" id={combinedImgId}><img id={combinedImgId} src={require("../pictures/cultist.png")} alt="ship" width="30" height="30"/></div>
      }else if(this.state.active && this.state.selected && this.state.unit.name==="Fanatic"){
        return <div className="selected" id={combinedImgId}><img id={combinedImgId} src={require("../pictures/cultist.png")} alt="ship" width="30" height="30"/></div>
      }else if(this.state.active && this.state.unit.name==="Fanatic"){
        return <div className="army2" id={combinedImgId}><img id={combinedImgId} src={require("../pictures/cultist.png")} alt="ship" width="30" height="30" /></div>
      }
        //Empty
      else{
        return ""
